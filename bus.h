...
public:
    ...
    char *getBusNo()            // "*" is used in character pointer variable to indicate that the given parameter is a pointer variable
    {
        return busNo;           // it will get single character at a time and reset the pointer
    }
